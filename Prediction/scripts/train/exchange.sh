...
python -u run.py \
    ...
    --query_model_path '../Retrieval/checkpoints/CaRTS_Retrieval_Retrieval_exchange_exchange_sl96_ll48_pl'$pred_len'_dm128_nh16_el3_df256_wd0_lr0.001_normTrue_Retrieval_0' \
